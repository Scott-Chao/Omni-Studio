...
void ActivityBar::setSearchActive(bool active)
{
    updateButtonStyle(m_searchBtn, active);
}

void ActivityBar::setJudgeActive(bool active)
{
    updateButtonStyle(m_judgeBtn, active);
}
